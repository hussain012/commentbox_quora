...
$user_id 	= 1; // it should be dynamic with current logged in ID
$logged_id = 1;
...
<a href="javascript: void(0)" id="post_id<?php  echo $row['p_id']?>" onclick="javascript: likethis(<?php echo $logged_id?>,<?php  echo $row['p_id']?>,1);">Like</a>
 - <a href="#" class="topopup" >Share</a>

    <div id="toPopup" class="center"  style="background-color: #EDEFF1; height:300px;width:500px;  ">
    ...
    <div id="popup_content"> <!--your content start-->
            Biturl is:  <br> <br>      
            <textarea style="height:65px;width:450px;">
            </textarea> <br>
