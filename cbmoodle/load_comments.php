...
<img  src="<?php echo $cface; ?>" class="shakeimage" onMouseover="init(this);rattleimage()" onMouseout="stoprattle(this);top.focus()" onClick="top.focus()"/>
</div>
-->
...
<a class="stcommentdelete" href="#" id='<?php echo $com_id; ?>' title="Delete Comment">
<?php 
    $admins = get_admins();
    $isadmin = false;
    foreach ($admins as $admin) {
     ...
     if(($uid==$USER->id) || ($isadmin == true))
      //if($uid==$USER->id) 
		 echo '<img width="10" align="left" style="border:none;" src="trash.png" class="shakeimage" onMouseover="init(this);rattleimage()" onMouseout="stoprattle(this);top.focus()" onClick="top.focus()">';
      else  
	     echo "";
?>
</a>
...
<?php echo '<a target="_blank" href="../user/view.php?id='.$uid.'&course='.$wcid.'">'.$username.'</a>'.' '.$comment;?> <!-- $username -->
